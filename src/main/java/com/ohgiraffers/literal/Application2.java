...
public class Application2 {
    ...
    public static void main(String[] args) {
        ...
        // 이 때 값의 형태에 따라 사용할 수 있는 연산자의 종류와 연산의ㅐ 결과가 달라진다.
        ...
        System.out.println(1.23 / 10.0);
        System.out.println(1.23 % 1.0); // 약각의 오차가 생긴다
        ...
        System.out.println('a' + 'b');   // a : 97, b : 98, A : 65 => ASCII code
        ...
        // 컴퓨터는 문자를 인식하지 못 하고 숫자로만 인식 할 수 있기 때문에,
        // 모든 문자에 대응되는 숫자들이 매칭이 되어 있다. (ASCII코드와 유니코드)
        ...
        // 결국 지금까지 연산은 숫자끼리의 연산을 본 것이고, 숫자(정수 혹은 실수) 형태의 값음
        ...
        // 문자열과의 연산은 '+' 연산만 가능하다.
        // 문자열과는 다른 형태의 값들도 문자열로 취급하여 문자열 이어붙이기(문자열 합치기) 결과가 나오게 된다.
        ...
        // 주의 사항. 숫자로 된 문자열 형태의 값 '+' 연산의 결과가 문자열 합치기 결과가 되는 것에 주의해보자!
        System.out.println("123" + "456");
